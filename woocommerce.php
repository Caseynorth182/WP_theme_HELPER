      ...
      <article class="about">
        <div class="wrapper about__flex">
          ...
          <figure class="about__thumb">
            <img src="<? echo get_template_directory_uri();?>/assets/img/index__about_img.jpg" alt="Power lifter">
          </figure>
        </div>
      </article>
      <section class="sales">
          ...
          <div class="sales__slider slider">
            <section class="slider__slide stock">
              <a href="blog.html" class="stock__link" aria-label="Подробнее об акции скидка 20% на групповые занятия">
                <img src="<? echo get_template_directory_uri();?>/assets/img/index__sales_pic1.jpg" alt="" class="stock__thumb">
            ...
            <section class="slider__slide stock">
              <a href="blog.html" class="stock__link" aria-label="Подробнее об акции Скидка 30% на занятия с тренером">
                <img src="<? echo get_template_directory_uri();?>/assets/img/index__sales_pic2.jpg" alt="" class="stock__thumb">
