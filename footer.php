<div class="modal">
    ...
    <div class="footer">
      ...
      <!--     <a href="index.html" class="main-header__logolink" aria-label="Логотип-ссылка на Главную">
          ...
          <nav class="main-navigation">
            ...
            <?  //проверка, 1 узнаем какой у нас протокол
              $http_s = 'http' . ( (isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] != 'off') ? 's' : '') . '://';
              //Добовляем к протоколу на УРЛ из глобальной переменной и ключу в ней['SERVER_NAME']
      ...
      <footer class="main-footer wrapper">
        <div class="row main-footer__row">
          <div class="main-footer__widget main-footer__widget_copyright">
            <?
            if(is_active_sidebar('si_footer_col_1')){
              dynamic_sidebar('si_footer_col_1');
            }
            ?>
          </div>
          <div class="main-footer__widget">
           <?
            if(is_active_sidebar('si_footer_col_2')){
              dynamic_sidebar('si_footer_col_2');
            }
            ?>
          </div>
    ...
    <script src="<? echo get_template_directory_uri();?>/assets/js/js.js"></script>
  </body>
</html>